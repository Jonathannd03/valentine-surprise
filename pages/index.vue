<template>
  ...
  @click="triggerConfetti">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <!-- Main Content -->
      <div class="relative z-10 text-center p-6 md:p-12 bg-black/60 rounded-2xl shadow-xl backdrop-blur-md">
        <h1
          class="text-4xl md:text-6xl font-bold text-red-500 mb-6"
          v-motion="{
        ...
        <p
          class="text-lg md:text-xl text-white/80 mb-6 leading-relaxed"
          v-motion="{
            initial: { opacity: 0, y: 50 },
